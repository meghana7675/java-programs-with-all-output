...
# program 1b_array_list programs
**program1b ex1**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p1.png)

**program1b ex2**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p2.png)

**program1b ex3**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p3.png)

**program1b ex4**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p4.png)

**program1b ex5**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p5.png)

**program1b ex6**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p6.png)

# program1c Linked List Programs

**program1 ex1**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p7.png)

**program1 ex2**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p8.png)

**program1 ex3**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p9.png)

**program1 ex4**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/p10.png)

# program2-hashset demonstration
**program 2a**-(https://github.com/meghana7675/java-programs-with-all-output/blob/main/program2.png
